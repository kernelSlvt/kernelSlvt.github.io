...
- redis from scratch - best for learning about network programming and data structures [good starting point](https://build-your-own.org/redis/)
- music visualizer - [assignment by stanford](http://nifty.stanford.edu/2025/wayne-music-visualizer/)
- database from scratch - learn persistence, indexing and concurrency | [sqlite clone from in c](https://cstack.github.io/db_tutorial/) | [golang (more advanced)](https://build-your-own.org/database/)
- shell in c
- make your own scripting language [book](https://craftinginterpreters.com/)
- write your own chip8 emulator [c++](https://multigesture.net/articles/how-to-write-an-emulator-chip-8-interpreter/) [rust](https://jeremybanks.github.io/0dmg/)
- front end framework: [react from scratch (talk)](https://www.youtube.com/watch?v=_MAD4Oly9yg), [react in 160 lines of javascript (crazy stuff)](https://medium.com/@sweetpalma/gooact-react-in-160-lines-of-javascript-44e0742ad60f)
- version control like git: [minimal version in py](https://www.leshenko.net/p/ugit/#)
- regex engine in c: [article on speeding up searching](https://swtch.com/~rsc/regexp/regexp1.html)
- video player in c
...
- create databases in css
- write interpreter for languages within other languages
- making music synthesizers in spreadsheet formulas
- bash server written in bash
- compiler written in sed
- 3d engines in batch files.
...
- [Text editor written in C under 1000 lines of code with syntax highlighting and search](https://github.com/antirez/kilo)
